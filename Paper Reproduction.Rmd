...
```{r StataData}
#Note: to convert R data to STATA data, if you want to use STATA.
#library(foreign) 
#training2<-filter(training,orderstate_2==1)
#training3<-filter(training,orderstate_3==1)
#training5<-filter(training,orderstate_5==1)
#training6<-filter(training,orderstate_6==1)
#write.dta(training2,"training2.dta")
#write.dta(training3,"training3.dta")
#write.dta(training5,"training5.dta")
#write.dta(training6,"training6.dta")
```
